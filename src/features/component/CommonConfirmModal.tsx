    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <div className="w-25.5 h-25.5 rounded-full bg-[#EF43431A]
            flex items-center justify-center">
            <div className="w-16.75 h-16.75 rounded-full bg-[#ef4343]
              flex items-center justify-center">
        ...
        {/* Title */}
        <h2 className="text-white text-[28px] font-bold mb-3.75 leading-tight">
          {title}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            py-3.5 cursor-pointer rounded-xl font-semibold transition"
            onClick={onClose}
          >
            {cancelText}
          </button>
