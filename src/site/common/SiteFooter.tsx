      ...
      <div className="relative container-custom mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-[#9CA3AF] text-sm py-5">
          <div className="flex gap-4">
            <div className="w-[28px] h-[28px] rounded-full bg-[#FFFFFF0D] text-[#E9E8E8] flex items-center justify-center hover:bg-white/20 transition">
              <FaFacebookF size={14}/>
            </div>
            <div className="w-[28px] h-[28px] rounded-full bg-[#FFFFFF0D] text-[#E9E8E8] flex items-center justify-center hover:bg-white/20 transition">
              <FaYoutube size={14}/>
          ...
          <p className="text-[#BEBEC2] text-lg font-medium">© 2026 CryptosFort. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
